...
public abstract class BaseDao {
     ...
     * @return
     */
    public <T> Pager<T> pagerBySql(String sql, Class<T> clazz, Pager<T> pager, Map<String,Object> params){
     ...
     * @return
     */
    public <T> Pager<T> pagerBySql(String sql,Class<T> clazz,Pager<T> pager,Object ... params){
        SQLQuery sqlQuery = buildTransformSQLQuery(sql,clazz,params);
        sqlQuery.setFirstResult(pager.getFirstResult());
        sqlQuery.setMaxResults(pager.getOnePageSize());
        pager.setData(find(sqlQuery));
